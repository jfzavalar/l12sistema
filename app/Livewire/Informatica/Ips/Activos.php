...
class Activos extends Component
{
    ...
    public $id_bien,$cod_pat,$cod_barra,$bien,$marca,$modelo,$serie,$medidas,$color,
            $est_cons,$cod_ubif,$desc_ubif,$cod_usuario,$desc_usuario,$cargo,$clase,$familia,
            $observa,$df,$nro_pecosa,$doc_adq,$ndoc_adq,$fecha_adq,$acoddepofi,
            $codsede_destino,$sede_destino,
            $coddependencia_destino,$dependencia_destino,
            $anomdepofi,$sedepofi,$codsede1,$nomsede,$estadoofi,$codgbien,$estado,$codcat,$codgclase;
