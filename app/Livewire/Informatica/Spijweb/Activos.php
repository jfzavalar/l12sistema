...
use WithFileUploads;
    ...
    {
        $lista_activos = InformaticasSpijweb::where('activo','1')
            // BUSCADOR
    ...
    public function guardar()
    {
        ...
        try {
            ...
            $existe = InformaticasSpijweb::where('dni', $this->dni)
    ...
    public function generarListaDeEntregaDeGastosOperativos($soloNuevo = false, $personaId = null)
    {
        ...
        foreach ($personas as $persona) {
            ...
            $existe = InformaticasSpijweb::where('persona_id', $persona->persona_id)
    ...
    public function editar_entregado(InformaticasSpijweb $registro, $mes)
    {
    ...
    {
        $registro = InformaticasSpijweb::find(
