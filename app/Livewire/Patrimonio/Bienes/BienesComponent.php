...
class BienesComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.patrimonio.bienes.bienes-component',
    ...
    public function editar(PatrimoniosBiene $ibien){
        ...
        $this->medidas = $ibien->medidas;
        $this->color = $ibien->color;
        $this->estado = $ibien->estado;
        $this->clase = $ibien->clase;
        $this->familia = $ibien->familia;
        $this->observa = $ibien->observa;
        $this->nro_pecosa = $ibien->nro_pecosa;
        $this->doc_adq = $ibien->doc_adq;
        $this->ndoc_adq = $ibien->ndoc_adq;
        $this->fecha_adq = $ibien->fecha_adq;
    }
