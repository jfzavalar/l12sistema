...
<html lang="es" data-bs-theme="light">
    <head>
        ...
        <link href="{{ asset('superadmin/bootstrap/dashboard/dashboard.css') }}" rel="stylesheet" />
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                {{-- Sidebar --}}
                @include('layouts/bootstrap5/sidebar')
        ...
        <script src="{{ asset('superadmin/bootstrap/dashboard/dashboard.js') }}" class="astro-vvvwv3sm"></script>
