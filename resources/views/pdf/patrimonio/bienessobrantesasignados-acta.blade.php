        ...
        <thead>
            <tr>
                <th style="background-color: black; color: white; text-align: center;">
                    ORDEN DE DESPLAZAMIENTO INTERNO DE BIENES SOBRANTES N° {{ $iasignacion->id }}
    ...
    <table width="100%" style="font-size: 9px;">
        <thead>
            <tr>
                ...
                <th style="border-top: 1px solid black; border-bottom: 1px solid black;">Correlativo Inventario</th>
        ...
        <tbody>
            @foreach ($ibien ?? [] as $item)
                <tr>
                    <td style="text-align: center; vertical-align: top;"><b>{{ $loop->iteration }}</b></td>
                    <td style="text-align: center; vertical-align: top;">{{ $item->codigo_patrimonial }}</td>
                    {{-- <td>{{ $item->codigo_barra }}</td> --}}
                    <td style="text-align: center; vertical-align: top;">{{ $item->descripcion }}</td>
                    <td style="text-align: center; vertical-align: top;">{{ $item->marca }}</td>
                    <td style="text-align: center; vertical-align: top;">{{ $item->modelo }}</td>
                    <td style="text-align: center; vertical-align: top;">{{ $item->nro_serie }}</td>
                    <td style="text-align: center; vertical-align: top;">{{ $item->medidas }}</td>
                    <td style="text-align: center; vertical-align: top;">{{ $item->estado }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
