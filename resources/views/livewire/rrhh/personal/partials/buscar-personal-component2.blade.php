...
<div wire:ignore.self class="modal fade" id="buscar-personal-component2" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="buscar-personal-componentLabel" aria-hidden="true">
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-{{ $colorAgregar}} btn-xs" wire:click="agregar_persona2({{ $persona->id }})" data-bs-toggle="modal" data-bs-target="#nuevoEditarModal">
