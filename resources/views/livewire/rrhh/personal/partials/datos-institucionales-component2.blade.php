...
<div class="row">
    <div class="col-xl-6 col-lg-6 col-sm-12">
        ...
        <input type="text" id="txtcelular_institucional2" class="form-control form-control-xs" wire:model="celinstitucional2">
    </div>
    <div class="col-xl-6 col-lg-6 col-sm-12">
        <label for="txtcorreo_institucional2" class="fw-bold fs-6">Correo institucional</label>
        <input type="text" id="txtcorreo_institucional2" class="form-control form-control-xs text-lowercase" wire:model="correoinstitucional2">
    </div>
</div>
<div class="row">
    <div class="col-xl-3 col-lg-6 col-sm-12">
