<div class="row">
    <div class="col-xl-12 col-lg-6 col-sm-12">      
        <div class="row">
            <div class="col">
                <label class="fw-bold fs-6">DNI</label>
            ...
            <div class="col">
                <label class="fw-bold fs-6">Nombres</label>
    ...
    <div class="col-xl-12 col-lg-6 col-sm-12">
        <div class="row">
            <div class="col">
                <label class="fw-bold fs-6">Apellido paterno</label>
                ...
                <div class="col">
                    <label class="fw-bold fs-6">Apellido materno</label>
