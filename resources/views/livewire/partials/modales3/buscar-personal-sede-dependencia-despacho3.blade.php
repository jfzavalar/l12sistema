<div class="modal fade @if($modalPersonalSedeBuscar3) show d-block @endif bg-secondary bg-opacity-75" tabindex="-1">
        ...
        <div class="modal-content">
            <form action="">
                <div class="modal-header bg-dark text-white">
                    ...
                    <button type="button" class="btn-close" aria-label="Close" wire:click="cerrarBuscar3"></button>
                </div>
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-{{ $colorAgregar}} btn-xs" wire:click="agregar_sede3({{ $sede->id }})">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary btn-sm" wire:click="cerrarBuscar3">
...
<div class="modal fade @if($modalPersonalDependenciaBuscar3) show d-block @endif bg-secondary bg-opacity-75" tabindex="-1">
                                ...
                                @forelse ($lista_dependencias2 as $dependencia)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-{{ $colorAgregar}} btn-xs" wire:click="agregar_dependencia3({{ $dependencia->id }})">
                                                        <i class="fa-solid fa-circle-plus"></i> Agregar
                                                    </button>
                                                </div>
                                            </div>
...
<div class="modal fade @if($modalPersonalDespachoBuscar3) show d-block @endif bg-secondary bg-opacity-75" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="">
                <div class="modal-header bg-dark text-white">
                                ...
                                @forelse ($lista_despachos as $despacho)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-{{ $colorAgregar}} btn-xs" wire:click="agregar_despacho3({{ $despacho->id }})">
                                                        <i class="fa-solid fa-circle-plus"></i> Agregar
                                                    </button>
                                                </div>
                                            </div>
