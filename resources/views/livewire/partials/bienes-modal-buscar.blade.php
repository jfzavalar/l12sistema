<div class="modal fade @if($modal_abierto_bienes_buscar ) show d-block @endif" tabindex="-1">
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                   <button type="button" class="btn btn-outline-success btn-sm" wire:click="agregar_bienes({{ $bieninformatico->id}})" data-bs-toggle="modal" data-bs-target="#new-edit-Modal">
