                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                   <button type="button" class="btn btn-outline-success"  wire:click="agregar_bienes({{ $bieninformatico->id}})" @disabled(($bieninformatico->desplazamiento == '1' && $traslado == 'TRASLADADO') || ($bieninformatico->desplazamiento == '0' && $traslado == 'DEVOLUCION'))>
