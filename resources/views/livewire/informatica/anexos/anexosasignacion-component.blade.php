                ...
                <table class="table table-striped table-hover table-sm table-xsmall">
                    <thead class="table-primary text-center align-middle">
                        <tr>
                            ...
                            <th scope="col" class="table-success">MARCA</th>
                            <th scope="col" class="table-success">MODELO</th>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <input type="text" id="txtserie" class="form-control form-control-xs" wire:model="marca" disabled>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label for="txtmodelo" class="fw-bold fs-6">MODELO:</label>
                                                        <input type="text" id="txtserie" class="form-control form-control-xs" wire:model="modelo" disabled>
                                                    </div>
