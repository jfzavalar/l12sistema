        ...
        <div class="modal-content">
            <form wire:submit.prevent="actualizar_pdf">
                <div class="modal-header bg-warning-subtle">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-bs-toggle="modal" data-bs-target="#historial-componentModal"></button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#historial-componentModal">
