<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-1 pb-1 mb-2 border-bottom">
        <h1 class="h2">
            <i class="fa-brands fa-usb"></i> TOKENS
        </h1>
        <div class="row">
            <div class="col-auto">
                ...
                <button class="btn text-start p-0 border-0 bg-transparent" wire:click="filtrarAsignados">
                    <span class="alert alert-success d-block mb-0">
                        <span class="fw-bold">
                            ...
                            ASIGANDOS: {{ $estadisticas->asignacion }}
                        </span>
                    </span>
                </button>
            </div>
            ...
            <div class="col-auto">
                <button class="btn text-start p-0 border-0 bg-transparent" wire:click="filtrarDevueltos">
                    <span class="alert alert-danger d-block mb-0">
                        <span class="fw-bold">
                            <i class="fa-solid fa-check-double"></i>
                            DEVUELTOS: {{ $estadisticas->devolucion }}
                        </span>
                    </span>
                </button>
            </div>
            ...
            <div class="col-auto">
                <button class="btn text-start p-0 border-0 bg-transparent" wire:click="filtrarFirmadas">
                    <span class="alert alert-success d-block mb-0">
                        <span class="fw-bold">
                            <i class="fa-solid fa-check-double"></i>
                            FIRMADOS: {{ $estadisticas->firmadas }}
                        </span>
                    </span>
                </button>
            </div>
            ...
            <div class="col-auto">
                <button class="btn text-start p-0 border-0 bg-transparent" wire:click="filtrarSinFirmar">
                    <span class="alert alert-danger d-block mb-0">
                        <span class="fw-bold">
                            <i class="fa-solid fa-check-double"></i>
                            SIN FIRMAR: {{ $estadisticas->sin_firmar }}
                        </span>
                    </span>
                </button>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="text" id="txtsearcha" class="form-control form-control-sm me-1" wire:model.live="search" placeholder="Buscar por DNI o Datos del Personal">
                            @can('procesos.informatica.firmasdigitales.index')
                                <button type="button" id="btnnuevo" class="btn btn-primary btn-sm me-1" wire:click="nuevo">
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('procesos.informatica.tokens.edit')
                                        @if ($item->asignacion == "ASIGNACION" || $item->asignacion == "REASIGNACION")
                                            <button type="button" class="btn btn-outline-secondary btn-xs" wire:click="nuevo_devolucion({{ $item->id }})">
                                                <i class="fas fa-exchange-alt"></i><br>Devolver
                                            </button>
                                        @endif
                                        @if ($item->asignacion == "DEVOLUCION")
                                            <button type="button" class="btn btn-outline-danger btn-xs" wire:click="nuevo_reasignacion({{ $item->id }})">
                                ...
                                <td>
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-outline-info btn-xs" wire:click="historial('{{ $item->token_id }}')">
    ...
    <div>
                                    ...
                                    <fieldset class="border p-3 rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-6 col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    <button type="button" class="btn btn-{{ $colorGuardarActualizar }} btn-xs" wire:click="tokenBuscar">
        ...
        <!-- MODAL BUSCAR TOKEN -->
        <div class="modal fade @if($modalTokenBuscar) show d-block @endif bg-secondary bg-opacity-75" tabindex="-1">
                ...
                <div class="modal-content rounded-5">
                    <form action="">
                        <div class="modal-header bg-{{ $colorHeaderModal }}">
                            ...
                            <button type="button" class="btn-close" aria-label="Close" wire:click="cerrar_token"></button>
                        </div>
                        <div class="modal-body">
                            <div class="table-responsive-xl">
                                <form>
                                        ...
                                        @forelse ($lista_bienes_tokens as $token)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                        <div class="btn-group" role="group">
                                                            <button type="button" class="btn btn-{{ $colorAgregar}} btn-xs" wire:click="agregar_token({{ $token->id }})">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary btn-sm" wire:click="cerrar_token">
