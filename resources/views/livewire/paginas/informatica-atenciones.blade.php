                    ...
                    <div class="row g-3">                      
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input type="text" name="txtsearchpersonalatenciones2" id="txtsearchpersonalatenciones2" class="form-control form-control-sm me-1" placeholder="Ingrese su DNI" wire:model.live="search">
                                ...
                                <fieldset class="border p-3 rounded mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-2">
                                            ...
                                            <select id="cmb_reportado" class="form-select form-select-xs" wire:model="reportado_por" disabled>
